...
@Composable
fun ActiveFullWidthSquareAdButton(
    ...
    val backgroundColor by animateColorAsState(
        ...
        label = "Active full-width square ad button background color animation"
    )
    val contentColor by animateColorAsState(
        ...
        label = "Active full-width square ad button content color animation"
    )
...
@Preview
@Composable
private fun ActiveFullWidthSquareAdButtonPrev() {
